...
const ADMINS = [
  ...
  { key: 'team',    name: 'Unimatcha Operations Team', role: 'TEAM',      schoolId: null,                     org: 'Unimatcha Team' },
...
const OFFICIAL_POSTS = [
  ...
  { adminKey: 'team',    board: 'RECOMMEND',   school: null,                      title: 'Dual-mode launch announcement', content: 'Unimatcha now has a brand-new dual mode: partner + friend, find both kinds of connection at once. Update to the latest version to try it out.', imgs: [IMG(303)], h: 14, sponsored: false, pinned: false, weight: 8 },
  { adminKey: 'sponsor', board: 'RECOMMEND',   school: null,                      title: 'Campus coffee season', content: 'Show your Unimatcha school verification at any Starbucks store to get your second drink half price. Offer runs until the end of the month.', imgs: [IMG(304)], h: 20, sponsored: true,  pinned: false, weight: 6 },
