...
(function () {
  ...
  var KB = [
    ...
    { k: ['密码', '忘记', 'password', 'forgot'],
      zh: '在登录页点「忘记密码」按提示操作；遇到问题发邮件到 contact@unimatcha.ai，我们帮你处理。',
      en: 'Use "Forgot Password" on the sign-in page, or email contact@unimatcha.ai and we\'ll sort it out.' },
    ...
    { k: ['广告', '投放', '商家', 'advertis', 'ad ', 'ads', 'merchant'],
      zh: '商家可以在抹茶按校园定向投放广告（支持包断/按展示/按点击多种计价），由投放学校的学生会先行审核。合作请邮件 contact@unimatcha.ai。',
      en: 'Merchants can run campus-targeted ads (buyout / CPM / CPC), reviewed first by the campus student union. Email contact@unimatcha.ai to talk.' },
    ...
    { k: ['举报', '骚扰', '不良', 'report', 'harass', 'abuse'],
      zh: '帖子、评论、用户资料都可以在应用内一键举报：本校学生会先审、平台复核，结果会通知你。紧急情况直接邮件 contact@unimatcha.ai，安全类邮件优先处理。',
      en: 'Report posts, comments or profiles in one tap — union review first, platform double-check, and you get the outcome. Emergencies: contact@unimatcha.ai (prioritised).' },
    ...
    { k: ['人工', '客服', '联系', '邮箱', 'human', 'contact', 'email', 'support'],
      zh: '人工支持请邮件 contact@unimatcha.ai，7 个工作日内回复（安全类优先）。',
      en: 'For a human, email contact@unimatcha.ai — we reply within 7 working days (safety mail prioritised).' }
  ];
  ...
  var TXT = {
    zh: { title: '抹茶小助手', sub: '自动回复 · 即时在线', ph: '输入你的问题…', send: '发送',
      ...
      more: '完整问题列表在帮助中心 →', mail: '联系人工：contact@unimatcha.ai' },
    en: { title: 'Matcha Assistant', sub: 'Auto-reply · online', ph: 'Type your question…', send: 'Send',
      ...
      more: 'Full list in the Help Center →', mail: 'Human support: contact@unimatcha.ai' }
  };
  ...
  function answer(q) {
    ...
    var t = TXT[l];
    return esc(t.fallback) + '<br><a href="faq.html">' + esc(t.more) + '</a><br><a href="mailto:contact@unimatcha.ai">' + esc(t.mail) + '</a>';
  }
